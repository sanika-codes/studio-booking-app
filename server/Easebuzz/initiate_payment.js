...
let initiate_payment = function (data, config, res) {
  ...
  function geturl(env) {
    if (env == "test") {
      ...
      // url_link = 'https://corsproxy.io/?' + encodeURIComponent('https://pay.easebuzz.in/');
  ...
  function pay(access_key, url_main) {
    //Changed this function to return access key to front end in Easebuzz.js component because original easebuzz code was giving cors error.
